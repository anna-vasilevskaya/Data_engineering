...
def load_and_process_dataset(file_url: str) -> pd.DataFrame:
    ...
    raw_data['Notes'] = raw_data['Notes'].astype('object')  # Keep as object for long texts
...
def main():
    ...
    raw_data.to_parquet("data/processed/dataset.parquet", index=False)  # сохраняем в папку processed в формате parquet
